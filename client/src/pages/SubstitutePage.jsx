...
const SubstitutePage = () => {
  return (
    <div style={{ padding: 24, background: COLORS.lightBg }}>
      <h1 style={{ color: COLORS.dark, marginBottom: 24, fontWeight: 600 }}>Substitute Dashboard</h1>
      
      <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
        {[
          { icon: <Users color={COLORS.primary} size={20} />, title: 'Delegated Tasks', value: 5, color: COLORS.primary },
          { icon: <CheckCircle color={COLORS.success} size={20} />, title: 'Completed', value: 2, color: COLORS.success },
          { icon: <Clock color={COLORS.warning} size={20} />, title: 'In Progress', value: 2, color: COLORS.warning },
        ...
        <Table 
          columns={[
            ...
            { 
              ...
              dataIndex: 'original', 
              key: 'original',
              render: (text) => <span style={{ color: COLORS.info }}>{text}</span>
            },
            { 
              title: 'Deadline', 
              dataIndex: 'deadline', 
